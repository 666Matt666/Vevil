...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener lista de productos (con soporte de paginación)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de productos obtenida exitosamente', type: [product_entity_1.Product] }),
    (0, swagger_1.ApiBearerAuth)(),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Producto actualizado', type: product_entity_1.Product }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Producto no encontrado' }),
    (0, swagger_1.ApiBearerAuth)(),
    __param(0, (0, common_1.Param)('id')),
