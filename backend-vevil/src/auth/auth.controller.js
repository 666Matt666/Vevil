...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.login = function (req, loginDto) {
        ...
        AuthController_1.prototype.refreshTokens = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var sub, refreshToken;
                return __generator(this, function (_a) {
                    sub = user.sub, refreshToken = user.refreshToken;
                    return [2 /*return*/, this.authService.refreshTokens(sub, refreshToken)];
                });
            });
        };
