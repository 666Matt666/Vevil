...
var ProfileController = function () {
    ...
    var _getAdminProfile_decorators;
    var ProfileController = _classThis = /** @class */ (function () {
        ...
        ProfileController_1.prototype.getAdminProfile = function (req) {
            return {
    ...
    (function () {
        ...
        _getProfile_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')), (0, common_1.Get)()];
        _getAdminProfile_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN), (0, common_1.Get)('admin')];
        ...
        __esDecorate(_classThis, null, _getAdminProfile_decorators, { kind: "method", name: "getAdminProfile", static: false, private: false, access: { has: function (obj) { return "getAdminProfile" in obj; }, get: function (obj) { return obj.getAdminProfile; } }, metadata: _metadata }, null, _instanceExtraInitializers);
