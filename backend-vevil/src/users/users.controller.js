...
var exclude_password_interceptor_1 = require("../common/interceptors/exclude-password.interceptor");
var paginated_users_response_dto_1 = require("./dto/paginated-users-response.dto");
var file_naming_util_1 = require("./utils/file-naming.util");
var swagger_1 = require("@nestjs/swagger");
var UsersController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Users'), (0, common_1.Controller)('users'), (0, common_1.UseInterceptors)(exclude_password_interceptor_1.ExcludePasswordInterceptor)];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.findAll = function (paginationQuery) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, users, total;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.usersService.findAll(paginationQuery)];
                        case 1:
                            _a = _b.sent(), users = _a[0], total = _a[1];
                            return [2 /*return*/, { data: users, total: total }];
                    }
                });
            });
        };
        UsersController_1.prototype.uploadAvatar = function (user, file) {
        ...
        UsersController_1.prototype.update = function (id, updateUserDto, user) {
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({ summary: 'Crear un nuevo usuario (Solo para Admins)' }), (0, swagger_1.ApiResponse)({ status: 201, description: 'El usuario ha sido creado exitosamente.', type: user_entity_1.User }), (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden. No tienes permiso.' })];
        _findAll_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Obtener una lista de todos los usuarios' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de usuarios paginada.', type: paginated_users_response_dto_1.PaginatedUsersResponseDto }), (0, common_1.UseInterceptors)(cache_manager_1.CacheInterceptor)];
        _uploadAvatar_decorators = [(0, common_1.Post)('avatar'), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('avatar', {
                ...
                storage: (0, multer_1.diskStorage)({
                    ...
                    filename: file_naming_util_1.editFileName, // La función que acabamos de crear para renombrar el archivo
                }),
            }))];
