                ...
                jwt_1.JwtModule.registerAsync({
                    ...
                    useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, ({
                                    secret: configService.get('JWT_SECRET'), // Usaremos una variable de entorno para el secreto
                                    signOptions: { expiresIn: '15m' }, // El token de acceso ahora expira en 15 minutos
                                })];
                        });
                    }); },
                }),
